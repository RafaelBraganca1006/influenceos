...
// ── Collapsible Section ───────────────────────────────────────────────────────
function Section({ id, title, sub, children, defaultOpen = true }) {
...
// ── Main Component ────────────────────────────────────────────────────────────
export default function InfluencerDetail({ id, onBack, onOpenPipeline, onNewPipeline }) {
  ...
  return (
    <div style={{ display: 'flex', gap: 0, margin: '-28px -32px', minHeight: 'calc(100vh - 58px)' }}>
      ...
      <div style={{ flex: 1, padding: '28px 32px', overflowY: 'auto', background: 'var(--bg)' }}>
        ...
        {/* Pipelines */}
        <Section id="section-pipelines" title="Pipelines" sub="Visual workflow builder — chain LLM, image, and video nodes">
